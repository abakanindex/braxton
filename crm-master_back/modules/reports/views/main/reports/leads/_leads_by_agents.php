...
//                if (is_numeric($model->agent_1))
//                    return $model->agent_1;
//                else
                    return $model->agent_1;
            },
        ],
    ...
    <div class="distribution-block">
        <?php if ($provider->pagination->params['page'] < 2) : ?>
            ...
            <div class="distribution-pie distribution-tab" style="height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/leads_by_agents__pie', ['provider' => $provider]);
                ?>
            </div>
            <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/leads_by_agents__bar', ['provider' => $provider]);
                ?>
            </div>
        <?php endif; ?>
    </div>
