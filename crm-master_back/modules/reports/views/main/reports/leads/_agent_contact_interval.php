...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            'header' => Yii::t('app', 'Lead Ref'),
            'value' => function ($model) {
                return $model->reference;
            },
        ],
        [
            'header' => Yii::t('app', 'Agent name'),
            'value' => function ($model) {
                return $model->noteAgentName;
            },
        ],
        [
            'header' => Yii::t('app', 'Contact Time In Days'),
            'value' => function ($model) {
                return $model->agentContactIntervalDays;
            },
        ],
        'number',
        [
    ...
    <div class="distribution-block">
        <?php if ($provider->pagination->params['page'] < 2) : ?>
            ...
            <div class="distribution-pie distribution-tab" style="height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/agent_contact_interval__pie', ['provider' => $provider]);
                ?>
            </div>
            <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/agent_contact_interval__bar', ['provider' => $provider]);
                ?>
            </div>
        <?php endif; ?>
    </div>
