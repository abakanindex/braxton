...
echo GridView::widget([
    ...
    'summary' => "Showing $provider->totalCount items",
    'formatter' => ['class' => 'yii\i18n\Formatter', 'nullDisplay' => ''],
    'columns' => [
        [
            'header' => '',
            'class' => \app\modules\reports\components\ColorSerialPdfColumn::class
        ],
        'status',
        'number',
        [
...
<div class="distribution-block">
    <h4><?= Yii::t('app', 'Distribution of Leads') ?>
        <h4>
            <?php
            ...
            ?>
            <div class="distribution-pie distribution-tab distribution-pie-pdf">
                <?php
                $labels = [];
                $data = [];
                $backgroundColors = [];
