...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            'header' => Yii::t('app', 'Number (The first value is number of open leads)'),
            'value' => 'number',
        ],
        [
    ...
    <div class="distribution-block">
        <?php if ($provider->pagination->params['page'] < 2) : ?>
            ...
            <div class="distribution-pie distribution-tab" style="height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/open_leads__pie', ['provider' => $provider]);
                ?>
            </div>
            <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/open_leads__bar', ['provider' => $provider]);
                ?>
            </div>
        <?php endif; ?>
    </div>
