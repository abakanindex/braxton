...
<div class="distribution-block">
    ...
    <div class="distribution-pie distribution-tab" style="height: 400px">
        <?php
        echo $this->render($viewsPath . 'charts/sales_by_category__pie', ['provider' => $provider]);
        ?>
    </div>
    <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
        <?php echo $this->render($viewsPath . 'charts/sales_by_category__bar', ['provider' => $provider]); ?>
    </div>
    <?php endif; ?>
</div>
<?php Pjax::end(); ?>
