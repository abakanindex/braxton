    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                if (is_numeric($model->category_id))
...
<div class="distribution-block">
    ...
    <h4><?= Yii::t('app', 'Distribution of Rentals') ?></h4>
    ...
    <div class="distribution-pie distribution-tab" style="height: 400px">
        <?php
        echo $this->render($viewsPath . 'charts/rentals_by_category__pie', ['provider' => $provider]);
        ?>
    </div>
    <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
        <?php
        echo $this->render($viewsPath . 'charts/rentals_by_category__bar', ['provider' => $provider]);
         ?>
    </div>
    <?php endif; ?>
</div>
