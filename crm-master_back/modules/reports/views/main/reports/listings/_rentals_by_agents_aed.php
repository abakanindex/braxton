...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            'header' => Yii::t('app', 'AED'),
            'value' => function ($model) {
                return $model->priceCommon;
            },
        ],
    ],
]);
    ...
    <div class="distribution-block">
        <?php if ($provider->pagination->params['page'] < 2) : ?>
            ...
            <div class="distribution-pie distribution-tab" style="height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/rentals_by_agents_aed__pie', ['provider' => $provider]);
                ?>
            </div>
            <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
                <?php
                echo $this->render($viewsPath . 'charts/rentals_by_agents_aed__bar', ['provider' => $provider]);
                ?>
            </div>
        <?php endif; ?>
    </div>
