...
<ul class="list-inline container-fluid">
    ...
    <?php elseif(Yii::$app->controller->action->id === 'view-archive'):?>
        <?php if(Yii::$app->user->can('rentalsCreate') or Yii::$app->user->can('Admin') or Yii::$app->user->can('Owner')): ?>
            <li class="">
                <?= Html::a(
                        '<i class="fa fa-plus-circle"></i>New Listing',
                        Url::toRoute(['/rentals/rentals/create']),
                        [
                            'id'    => 'add-new-element',
    ...
    <?php else:?>
        ...
        <?php endif; ?>
        <?php if(Yii::$app->user->can('rentalsUpdate') or Yii::$app->user->can('Admin') or Yii::$app->user->can('Owner')): ?>
            <li class="">
                <?= Html::a(
                    '<i class="fa fa-pencil-square-o"></i>Edit Listing',
                    Url::toRoute(['/rentals/rentals/update', 'id' => $topModel->id]),
                    [
                        'id'        => 'edit-element',
                        'class'     => 'btn red-button',
                        'data-pjax' => '1',
        ...
        <?php endif; ?>
        <?php if(Yii::$app->user->can('rentalsDelete') or Yii::$app->user->can('Admin') or Yii::$app->user->can('Owner')): ?>
            <li class="">
                <?= Html::a(
