...
/**
 * This is the model class for table "rentals_archive".
 *
 * @property int $id
 ...
 */
class RentalsArchive extends \yii\db\ActiveRecord implements iRelationShip, IfirstRecordModel
{
