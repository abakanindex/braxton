...
/**
 * CommercialSalesSearch represents the model behind the search form of `app\models\CommercialSales`.
 */
class CommercialSalesSearch extends CommercialSales
{
    /**
     * @inheritdoc
     */
