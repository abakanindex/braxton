...
/**
 * Handles the creation of table `commercial_rentals`.
 */
class m171031_213815_create_commercial_rentals_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('commercial_rentals', [
            'id' => $this->primaryKey(),
            'user_id' => $this->string(),
            'ref' => $this->string(),
    ...
    {
        $this->dropTable('commercial_rentals');
    }
}
