...
use yii\web\{UploadedFile, NotFoundHttpException, Controller};
use app\models\{
    Contacts, 
    Company, 
    UploadForm, 
...
use app\models\statusHistory\{StatusHistory, ArchiveHistory};
...
class SaleController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $archive = new ArchiveHistory($this->findModel($id));
    ...
    {
        $model = Sale::find()->where(['slug' => $slug])->one();
