...
<div
                ...
                <div class="tab-pane" id="reminder">
                    ...
                    <div class="tab-row">
                        <div class="panel panel-default">
                            <?= ReminderWidget::widget(['keyId' => $topModel->id, 'keyType' => Reminder::KEY_TYPE_RENTALS]) ?>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="documents">
                    <?= DocumentsWidget::widget(['model' => new Document(), 'ref' => $topModel->ref, 'keyType' => Document::KEY_TYPE_RENTAL])?>
                </div>
    ...
    <?= ViewingsSaleRentalWidget::widget(['model' => new Viewings(), 'ref' => $topModel->ref, 'type' => Viewings::TYPE_RENTAL]) ?>
</div>
