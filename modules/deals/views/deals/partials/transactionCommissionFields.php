...
<div class="col-md-6 rentals-big-block"><!-- transactionCommissionFields -->
    ...
    <div class="property-list">
        ...
        <hr/>
        <div class="form-group">
            <label for="inputAgent1" class="col-sm-6 control-label">
                <?= Yii::t('app', 'Agent 1') ?>
            </label>
            <div class="col-sm-6">
                <?= Html::input('text', '', $assignedToAgent1->username ?? $topModel->agent_1, [
                    'data-toggle'  => 'modal',
                    'data-target'  => '#agent1-gridview',
                    'class'        => 'form-control cursor-pointer',
                    'id'           => 'changeAgent1',
                    'disabled'     => $disabledAttribute,
                    'autocomplete' => 'off'
                ])?>
                <?= $form->field($topModel, 'agent_1', [
                    'template' => '{input}',
                    'options'  => [
                        'tag' => false,
                    ],
                ])->hiddenInput(['id' => 'agent1Deal'])->label(false);?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <?= Html::input('text', '', $assignedToAgent2->username ?? $topModel->agent_2, [
                    'data-toggle'  => 'modal',
                    'data-target'  => '#agent2-gridview',
                    'class'        => 'form-control cursor-pointer',
                    'id'           => 'changeAgent2',
                    'disabled'     => $disabledAttribute,
                    'autocomplete' => 'off'
                ])?>
                <?= $form->field($topModel, 'agent_2', [
                    'template' => '{input}',
                    'options'  => [
                        'tag' => false,
                    ],
                ])->hiddenInput(['id' => 'agent2Deal'])->label(false);?>
                <div class="help-block"></div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <?= Html::input('text', '', $assignedToAgent3->username ?? $topModel->agent_3, [
                    'data-toggle'  => 'modal',
                    'data-target'  => '#agent3-gridview',
                    'class'        => 'form-control cursor-pointer',
                    'id'           => 'changeAgent3',
                    'disabled'     => $disabledAttribute,
                    'autocomplete' => 'off'
                ])?>
                <?= $form->field($topModel, 'agent_3', [
                    'template' => '{input}',
                    'options'  => [
                        'tag' => false,
                    ],
                ])->hiddenInput(['id' => 'agent3Deal'])->label(false);?>
                <div class="help-block"></div>
            </div>
        </div>
        <div class="form-group">
...
<!--    <div id="media-tab">-->
        <div class="property-list" style="overflow-y: inherit">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'unit')
                        ->textInput(['disabled' => $disabledAttribute, 'id' => 'inputUnit', 'class' => 'form-control'])
                        ->label(false); ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'unit_type')
                        ->textInput(['disabled' => $disabledAttribute, 'id' => 'inputType', 'class' => 'form-control'])
                        ->label(false); ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'region_id')
                        ->dropDownList($emirates, ['disabled' => $disabledAttribute, 'prompt' => '', 'id' => 'emirateDropDown'])
                        ->label(false);?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'area_location_id')
                        ->dropDownList($locationsCurrent, ['disabled' => $disabledAttribute,
                            'prompt' => '',
                            'id' => 'locationDropDown'
                        ])
                        ->label(false)?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'sub_area_location_id')
                        ->dropDownList($subLocationsCurrent, ['disabled' => $disabledAttribute,
                            'prompt' => '',
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'street_no')
                        ->textInput(['disabled' => $disabledAttribute, 'id' => 'inputStreetNo', 'class' => 'form-control'])
                        ->label(false); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?= $form->field($unitModel, 'floor_no')
                        ->textInput(['disabled' => $disabledAttribute, 'id' => 'inputFloor', 'class' => 'form-control'])
                        ->label(false); ?>
                </div>
            </div>
