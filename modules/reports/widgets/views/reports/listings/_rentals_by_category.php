...
<?php
$chartUrl = Url::to(['/reports/report-widget/rentals-category-charts', 'id' => $report->url_id]);
...
$('#standart-widget-types-$report->url_id').on('change', function() { 
  if( this.value == $typePieChart )
      getRentalsCategoryChartData('pie', '$chartUrl', '$report->url_id');
  else if( this.value == $typeColumnChart )
      getRentalsCategoryChartData('bar', '$chartUrl', '$report->url_id');
...
function getRentalsCategoryChartData(type, url, reportId) {       
