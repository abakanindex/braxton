...
?>
    <div class="distribution-block">
        ...
        <h4><?= Yii::t('app', 'Distribution of Agent Leaderboard') ?></h4>
        ...
        <div class="distribution-pie distribution-tab" style="height: 400px">
            <?php
            echo $this->render($viewsPath . 'charts/agent_leader_board__pie', ['provider' => $provider]);
            ?>
        </div>
        <div class="distribution-bar distribution-tab" style="display: none; height: 400px">
            <?php
            echo $this->render($viewsPath . 'charts/agent_leader_board__bar', ['provider' => $provider]);
            ?>
        </div>
        <?php endif; ?>
    </div>
