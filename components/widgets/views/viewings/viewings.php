...
?>
                    ...
                    <div class="tab-header">
                        <?php if(Yii::$app->user->can('viewingCreate')):?>
                            ...
                            <div class="form-group">
                                <label for="viewingsListing" class="col-sm-5 control-label"><?= Yii::t('app', 'Lead') ?></label>
                                <div class="col-sm-7">
                                    <?= Html::a(
                                        ($model->listing_ref) ? $model->listing_ref : FA::icon('plus') . Yii::t('app', ' Select an existing lead'), '#', [
                                        'data-toggle' => 'modal',
                                        'data-target' => '#modal-viewing-leads',
                                        'id' => 'listingRefLink',
                                        'class' => 'no-margin'
                                    ]); ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <?= $form->field($model, 'client_name')->textInput(['id' => 'viewingsName'])->label(false) ?>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <li>
                                        <div class="pull-right">
                                            <?php if(Yii::$app->user->can('viewingUpdate')):?>
                                                <a href="<?= Yii::$app->getUrlManager()->createUrl(['viewing/load', 'id' => $v->id, 'ref' => $ref, 'type' => $type])?>" class="viewing-edit" data-pjax="0">
                                                    <?= Yii::t('app', 'Edit')?>
                                                </a>
                                            <?php endif;?>
                                        </div>
    ...
    Modal::begin([
        ...
        'id' => 'modal-viewing-leads',
        'size' => 'modal-lg',
        'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">'
            . Yii::t('app', 'OK')
            . '</button>',
    ]);
    Pjax::begin(['id' => 'viewings-leads-gridview', 'timeout' => false, 'enablePushState' => false]);
    ?>
        ...
        <div style="overflow-x: auto; padding-right: 0; padding-left: 0;" class="container-fluid clearfix">
            <?= GridView::widget([
                'tableOptions' => [
                    ...
                    'id' => 'viewings-leads-gridview'
                ],
                'dataProvider' => $leadViewingLeadsDataProvider,
                'filterModel' => $leadViewingLeadsSearchModel,
                'layout' => "{items}\n{pager}",
                'columns' => [
                    [
                        ...
                        'radioOptions' => function ($model) {
                                return [
                                    ...
                                    'data-full-name' => $model->last_name . ' ' . $model->first_name,
                    ...
                    [
                        ...
                        'filter' => Html::activeDropDownList($leadViewingLeadsSearchModel,
                                'type_id',
                                $types,
