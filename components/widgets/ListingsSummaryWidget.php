...
class ListingsSummaryWidget extends Widget
{
    public $model;
    public $archiveModel;
    public $pendingModel;
    ...
    public function init()
    {
        ...
        $this->data = array(
            'countPublished'   => $model::getCountByStatus($model::STATUS_PUBLISHED),
            'countDraft'       => $model::getCountByStatus($model::STATUS_DRAFT),
            'countUnPublished' => $archiveModel::getCountByStatus($archiveModel::STATUS_UNPUBLISHED),
            'countPending'     => $pendingModel::getCountByStatus($pendingModel::STATUS_PENDING),
    ...
    public function run()
    {
        return $this->render('listingsSummary/listings-summary', [
            'data' => $this->data
        ]);
    }
}
