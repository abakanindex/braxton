...
use app\models\SaleArchive;
use app\modules\admin\models\OwnerManageGroup;

/**
 * SaleArchiveSearch represents the model behind the search form of `app\models\SaleArchive`.
 */
class SaleArchiveSearch extends SaleArchive
{
    /**
     * {@inheritdoc}
     */
