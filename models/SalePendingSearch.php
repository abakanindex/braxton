...
use app\models\SalePending;
use app\modules\admin\models\OwnerManageGroup;

/**
 * SalePendingSearch represents the model behind the search form of `app\models\SalePending`.
 */
class SalePendingSearch extends SalePending
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['=', 'status', $this->status])
            ...
            ->andFilterWhere(['=', 'other_title_2', $this->other_title_2])
