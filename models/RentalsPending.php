...
/**
 * This is the model class for table "rentals_pending".
 *
 * @property int $id
 ...
 */
class RentalsPending extends \yii\db\ActiveRecord implements iRelationShip, IfirstRecordModel
{
